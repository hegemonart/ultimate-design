...
# Pipeline State — design-to-verify-fail (pending design-keyword)

<!--
  Fail case: M-04 is still pending and its text mentions "component" —
  a design-stage keyword. designToVerify blocks the transition until
  the item is resolved (pass/fail).
-->
...
M-04: Primary button component matches Figma spec | status: pending
</must_haves>
